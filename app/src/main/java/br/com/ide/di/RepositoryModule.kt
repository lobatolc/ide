...
import br.com.ide.data.repository.FirestoreMissionParticipantRepository
...
abstract class RepositoryModule {
    ...
    @Binds
    @Singleton
    abstract fun bindMissionParticipantRepository(
        repository: FirestoreMissionParticipantRepository
